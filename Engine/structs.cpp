...
Rayf::Rayf(const Point2f& pointOne, const Point2f& pointTwo)
	: pointOne { pointOne }
	, pointTwo { pointTwo }
{
}

Rayf::Rayf(float x1, float y1, float x2, float y2)
	: pointOne { Point2f{ x1, y1 } }
	, pointTwo { Point2f{ x2, y2 } }
{
}

//-----------------------------------------------------------------
// LadderRectf Constructors
//-----------------------------------------------------------------

LadderRectf::LadderRectf()
	: LadderRectf{Rectf{}, false }
{
}

LadderRectf::LadderRectf(const Rectf& rect, bool endRect)
	: rect{ rect }
	, endRect{ endRect }
	, isOnScreen{ false }
{
...
LadderRectf::LadderRectf(float left, float bottom, float width, float height, bool endRect)
